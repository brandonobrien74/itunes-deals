...
define('WONDERPLUGIN_LIGHTBOX_VERSION', '7.2C');
...
define('WONDERPLUGIN_LIGHTBOX_PLUGIN_VERSION', '7.2');
...
class WonderPlugin_Lightbox_Plugin {
	...
	function register_menu()
	{
		...
		$menu = add_submenu_page(
				'wonderplugin_lightbox_overview',
				__('Register', 'wonderplugin_lightbox'),
				__('Register', 'wonderplugin_lightbox'),
				'manage_options',
				'wonderplugin_lightbox_register',
				array($this, 'register' ) );
		add_action( 'admin_print_styles-' . $menu, array($this, 'enqueue_admin_script') );
	}
...
define('WONDERPLUGIN_LIGHTBOX_VERSION_TYPE', 'C');
